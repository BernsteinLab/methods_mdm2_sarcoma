...
cd /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/hiChip/loop_annotation/DD20/
...
bedtools intersect -wa -wb -a promoters_loopAnnot_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_mdm2.bed > promoter_totalLoops_mdm2Bound.tmp

# MDM2-bound enhancers
bedtools intersect -wa -wb -a enhancers_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_mdm2.bed > enhancers_totalLoops_mdm2Bound.tmp

# cjun-bound promoters
bedtools intersect -wa -wb -a promoters_loopAnnot_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_cjun.bed > promoter_totalLoops_cjunBound.tmp

# cjun-bound enhancers
bedtools intersect -wa -wb -a enhancers_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_cjun.bed > enhancers_totalLoops_cjunBound.tmp
...
# MDM2-bound promoters
bedtools intersect -wa -wb -a "PP_loops/PP_promoters_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_mdm2.bed > "PP_loops/PP_promoter_totalLoops_mdm2Bound.tmp"
# cJun-bound promoters
bedtools intersect -wa -wb -a "PP_loops/PP_promoters_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_cjun.bed > "PP_loops/PP_promoter_totalLoops_cjunBound.tmp"
...
# MDM2-bound enhancers
bedtools intersect -wa -wb -a "EE_loops/EE_enhancers_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_mdm2.bed > "EE_loops/EE_enhancers_totalLoops_mdm2Bound.tmp"
# cJun-bound enhancers
bedtools intersect -wa -wb -a "EE_loops/EE_enhancers_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD20_cjun.bed > "EE_loops/EE_enhancers_totalLoops_cjunBound.tmp"
...
Rscript /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/scripts/DD20_loop_annotation_table.R $sample
