...
cd /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/hiChip/loop_annotation/DD31/
...
bedtools intersect -wa -wb -a promoters_loopAnnot_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_mdm2.bed > promoter_totalLoops_mdm2Bound.tmp

# MDM2-bound enhancers
bedtools intersect -wa -wb -a enhancers_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_mdm2.bed > enhancers_totalLoops_mdm2Bound.tmp

# cjun-bound promoters
bedtools intersect -wa -wb -a promoters_loopAnnot_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_cjun.bed > promoter_totalLoops_cjunBound.tmp

# cjun-bound enhancers
bedtools intersect -wa -wb -a enhancers_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_cjun.bed > enhancers_totalLoops_cjunBound.tmp

# runx-bound promoters
bedtools intersect -wa -wb -a promoters_loopAnnot_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_runx.bed > promoter_totalLoops_runxBound.tmp

# runx-bound enhancers
bedtools intersect -wa -wb -a enhancers_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_runx.bed > enhancers_totalLoops_runxBound.tmp

################################################################
## Create the quantification files

cut -f 2,3,4,21,38 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/MDM2_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_mdm2.bed | \
awk '{ print $6 "\t" $7 "\t" $8 "\t" $4 "\t" $5 }'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_DD31_mdm2.tmp

cut -f 2,3,4,21,32 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/cJun_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_cjun.bed | \
awk '{ print $6 "\t" $7 "\t" $8 "\t" $4 "\t" $5 }'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_DD31_cjun.tmp

cut -f 2,3,4,21,30 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/RUNX2_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_runx.bed | \
awk '{ print $6 "\t" $7 "\t" $8 "\t" $4 "\t" $5 }'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_DD31_runx.tmp
...
# MDM2-bound promoters
bedtools intersect -wa -wb -a "PP_loops/PP_promoters_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_mdm2.bed > "PP_loops/PP_promoter_totalLoops_mdm2Bound.tmp"
# cJun-bound promoters
bedtools intersect -wa -wb -a "PP_loops/PP_promoters_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_cjun.bed > "PP_loops/PP_promoter_totalLoops_cjunBound.tmp"
# RUNX-bound promoters
bedtools intersect -wa -wb -a "PP_loops/PP_promoters_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_runx.bed > "PP_loops/PP_promoter_totalLoops_runxBound.tmp"
...
# MDM2-bound enhancers
bedtools intersect -wa -wb -a "EE_loops/EE_enhancers_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_mdm2.bed > "EE_loops/EE_enhancers_totalLoops_mdm2Bound.tmp"
# cJun-bound enhancers
bedtools intersect -wa -wb -a "EE_loops/EE_enhancers_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_cjun.bed > "EE_loops/EE_enhancers_totalLoops_cjunBound.tmp"
# RUNX-bound enhancers
bedtools intersect -wa -wb -a "EE_loops/EE_enhancers_loopAnnot_totalLoops.tmp" -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/DD31_runx.bed > "EE_loops/EE_enhancers_totalLoops_runxBound.tmp"
...
Rscript /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/scripts/DD31_loop_annotation_table.R $sample
