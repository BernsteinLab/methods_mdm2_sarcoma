...
cd /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/hiChip/loop_annotation/LPS141_1/
...
# MDM2-unbound promoters
# bedtools intersect -wa -v -a promoters_loopAnnot_totalLoops.tmp -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/lps141_mdm2.bed > promoter_totalLoops_mdm2Unbound.tmp
...
cut -f 2,3,4,29,33,46,50 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/MDM2_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/lps141_mdm2.bed | \
awk '{ print $8 "\t" $9 "\t" $10 "\t" $4 "\t" $5 "\t" $6 "\t" $7}'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_lps141_mdm2.tmp

cut -f 2,3,4,20,24,30,34 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/p53_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/lps141_p53.bed | \
awk '{ print $8 "\t" $9 "\t" $10 "\t" $4 "\t" $5 "\t" $6 "\t" $7}'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_lps141_p53.tmp

cut -f 2,3,4,23,26,34,37 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/cJun_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/lps141_cjun.bed | \
awk '{ print $8 "\t" $9 "\t" $10 "\t" $4 "\t" $5 "\t" $6 "\t" $7}'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_lps141_cjun.tmp

cut -f 2,3,4,23,32 /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/RUNX2_DD_DMSO_nutlin_counts.txt \
| sed 1d | bedtools intersect -wa -wb -a stdin -b /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/lps141_runx.bed | \
awk '{ print $6 "\t" $7 "\t" $8 "\t" $4 "\t" $5 }'  > /seq/epiprod02/sgaldon/liposarcoma/chip_master_datasets/bed_files/quant_lps141_runx.tmp
